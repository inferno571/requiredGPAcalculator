...
## IMPORTANT: If you are not in CSE 2027 graduating batch, you must modify const credits according to your branch in source code to get accurate CGPA prediction. 
